...
{
	QString fileName = QFileDialog::getOpenFileName(this, tr("Open File"), QDir::currentPath(), tr("Image Files(*.jpg;*.png;*.bmp)"));
	if (!fileName.isEmpty())
	{
...
void drawPicXml::on_actionOpenFiles_triggered()
{
    ...
    fileNames = QFileDialog::getOpenFileNames(this, tr("Open Files"), QDir::currentPath(), tr("Image Files(*.jpg;*.png;*.bmp)"));
