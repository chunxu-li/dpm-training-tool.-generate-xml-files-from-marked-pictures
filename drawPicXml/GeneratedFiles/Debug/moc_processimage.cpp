...
struct qt_meta_stringdata_processimage_t {
    QByteArrayData data[4];
    char stringdata[66];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_processimage_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_processimage_t qt_meta_stringdata_processimage = {
    {
QT_MOC_LITERAL(0, 0, 12), // "processimage"
QT_MOC_LITERAL(1, 13, 25), // "on_pushButtonOpen_clicked"
QT_MOC_LITERAL(2, 39, 0), // ""
QT_MOC_LITERAL(3, 40, 25) // "on_pushButtonExit_clicked"

    },
    "processimage\0on_pushButtonOpen_clicked\0"
...
const QMetaObject processimage::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_processimage.data,
      qt_meta_data_processimage,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *processimage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_processimage.stringdata))
