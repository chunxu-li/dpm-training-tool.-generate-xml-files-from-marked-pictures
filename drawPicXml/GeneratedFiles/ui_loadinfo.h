...
public:
    ...
    void setupUi(QDialog *loadInfo)
    {
        ...
        widget->setGeometry(QRect(10, 22, 221, 220));
        verticalLayout = new QVBoxLayout(widget);
        verticalLayout->setObjectName(QStringLiteral("verticalLayout"));
        verticalLayout->setContentsMargins(0, 0, 0, 0);
        horizontalLayout = new QHBoxLayout();
        horizontalLayout->setObjectName(QStringLiteral("horizontalLayout"));
        objName = new QLabel(widget);
    ...
    void retranslateUi(QDialog *loadInfo)
    {
        ...
        comboBoxName->clear();
        comboBoxName->insertItems(0, QStringList()
         << QApplication::translate("loadInfo", "person", 0)
         << QApplication::translate("loadInfo", "chair", 0)
        );
        objPose->setText(QApplication::translate("loadInfo", "objPose:", 0));
        comboBoxPose->clear();
        comboBoxPose->insertItems(0, QStringList()
         << QApplication::translate("loadInfo", "Sit", 0)
         << QApplication::translate("loadInfo", "Stand", 0)
         << QApplication::translate("loadInfo", "Unspecified", 0)
        );
